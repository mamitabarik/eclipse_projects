...
@PropertySource(value="classpath:viva.properties")
@ComponentScan("com")
public class HibernateConfig {
	...
	public LocalSessionFactoryBean getSessionFactory(DriverManagerDataSource ds){
		...
		fac.setPackagesToScan(new String[]{"com.viva.entity"});
	...
	public Properties getProperties(){
		...
		props.setProperty("hibernate.pool_size", "5");
		props.setProperty("hibernate.hbm2ddl.auto", env.getProperty("hbm2ddl"));
		return props;
